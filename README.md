...
Toronto IX Traffic Simulation requires iperf3 and the numpy library to send traffic between devices.
...
The graph produced by my software, using a general polynomial which noise is added to for day by day variance, is shown below:
